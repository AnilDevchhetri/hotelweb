                ...
                <div class="col-lg-5 col-md-12 px-4">
                 ...
                 $row[name]
                            ...
                            if (!$settings_r['shutdown']) {
                                ...
                                $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])'  class='btn  w-100 text-white custom-bg mb-1'>Book Now</button>";
                            }

                            ?>
                            <div class="fecilites mb-3">
                          ...
                          echo <<<reviews
                                <div class='mb-3'>
                                    <div class=" d-flex align-items-center mb-2">
                                        <img src="$img_path$row[img]" width="30px" alt="">
