...
if(isset($_GET['del'])){
    ...
    if($frm_data['del']=='all'){
        ...
        if(mysqli_query($con,$q)){
            alert('success','All data Successfully Deleted');
        }else{
            alert('error','Operation failed');
        }
...
<head>
    ...
    <title>Admin Panal - Ratings & Reviews</title>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                            <div class="text-end mb-4">
                                <a href="?seen=all" class="btn btn-sm btn-dark rounded-pill shadow-none">Mark All read</a>
                                <a href="?del=all" class="btn btn-sm btn-danger rounded-pill shadow-none">Delete All </a>
                            </div>
