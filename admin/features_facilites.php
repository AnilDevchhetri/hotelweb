...
<head>
    ...
    <title>Admin Panal - Features and Facilities </title>
...
<body class="bg-light">
    ...
    <div class="container-fluid " id="main-content-dashboard">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <!-- Facilites card settings  -->
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">

                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Facilites</h5>
                            <button type="button" class="btn btn-dark shadow-none btn-sm " data-bs-toggle="modal" data-bs-target="#faciltiy-s">
                                <i class="bi bi-plus-square me-1"></i>Add
                            </button>
                        </div>
                        ...
                        <div class="table-responsive-md" style="height:350px; overflow-y:scroll ">
                            <table class="table table-hover border">
                                ...
                                <tbody id="facilities-data">
                                    <!-- facilities is added using script  -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class=" mb-3">
                            ...
                            <input type="Text" required name="feature_name" id="feature_name_inp" class="form-control shadow-none">
                        </div>
    ...
    <!-- Facilites Modal -->
    <div class="modal fade" id="faciltiy-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="facility_s_form">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">Add Facilites </h1>
                    </div>
                    <div class="modal-body">
                        <div class=" mb-3">
                            <label class="form-label fw-bold">Name</label>
                        ...
                        <div class=" mb-3">
                            ...
                            <input type="file" required name="facility_icon" accept=".svg" class="form-control shadow-none">
                        </div>
                        <div class="mb-3">
