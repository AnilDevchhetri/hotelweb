...
<head>
    ...
    <title>Admin Panal -Booking Records</title>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="text-end mb-4">
                            ...
                            <input type="text" id="search_input" oninput="get_bookings(this.value)" class="form-control shadow-none w-25 ms-auto" placeholder="Tpye to search">
                        </div>
