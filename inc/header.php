    ...
    ----Start of Navbar-----------
  ------------------------------------->
    <nav id="main-nav-bar" class="navbar navbar-expand-lg bg-body-tertiary bg-white px-lg-3 py-2 shadow-sm sticky-top">
            ...
            <div class="modal-content">
                <form id="login-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex align-center justify-content-between mb-2 align-items-center">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="register-form">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 d-flex align-items-center" id="staticBackdropLabel">
                            <i class="bi bi-person-lines-fill me-2 fs-3"></i>User Registration
                        </h1>
                        <button type="reset" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <span class="badge rounded-pill text-bg-light mb-3 text-wrap lh-base">
                            Note: Your details must with your ID(Aadhar card,Passport) will be required during Check in.
                        </span>
                        <div class="container-fluid">
                            <div class="row">
            ...
            <div class="modal-content">
                <form id="forgot-form">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                        <span class="badge rounded-pill text-bg-light mb-3 text-wrap lh-base">
                            Note: Link will be send to you email to reset your password
                        </span>
                            <label class="form-label">Email / Mobile</label>
                        ...
                        <div class="mb-3 text-end">
                            ...
                            <button type="button" class="btn text-decoration-none shadow-none p-0 me-2" data-bs-toggle="modal" data-bs-target="#LoginModal" data-bs-dismiss="modal">
                           Cancle
                        </button>
                        <Button class="btn btn-dark shadow-none">Send Link</Button>
