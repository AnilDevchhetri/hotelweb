...
if (isset($_GET['fetch_rooms'])) {
    ...
    while ($room_data  = mysqli_fetch_assoc($room_res)) {
        ...
        if (!$settings_r['shutdown']) {
            ...
            $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm w-100 text-white custom-bg mb-2'>Book Now</button>";
        }
